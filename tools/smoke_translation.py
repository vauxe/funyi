...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Smoke test HY-MT subtitle translation inference."
    )
    parser.add_argument(
        "--model",
    ...
    parser.add_argument(
        "--profile",
        action="store_true",
        help="Include encode/generate/decode timing and token counts.",
    )
            ...
            profiles.append(
                {
                    ...
                    "decode_tokens_per_sec": round(
                        result.generated_tokens / result.generate_wall_sec, 2
                    )
